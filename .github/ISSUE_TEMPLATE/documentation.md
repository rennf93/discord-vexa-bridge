...
name: Documentation
about: Report issues with the discord-vexa-bridge documentation or suggest improvements
title: '[DOCS] '
...
Link to (or name) the current documentation page or section that needs improvement: [Link it here](https://github.com/rennf93/discord-vexa-bridge)
